...
_vector_store_id = os.getenv("VECTOR_DATABSE")
...
def _run_rag(query: str) -> str:
    ...
    """
    results = client.vector_stores.search(vector_store_id=_vector_store_id, query=query, rewrite_query=True)  # Query rewriting generally improves results
...
def index_documents(directory: str):
    ...
    Args:
        directory: The directory to index te documents from
    """
...
if __name__ == "__main__":
    ...
    samples_dir = os.path.join(current_dir, "../data/raw/sample_files")
